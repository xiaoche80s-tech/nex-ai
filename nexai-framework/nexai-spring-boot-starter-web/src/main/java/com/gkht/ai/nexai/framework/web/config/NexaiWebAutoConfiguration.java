package com.gkht.ai.nexai.framework.web.config;
...
import com.gkht.ai.nexai.framework.web.core.filter.CacheRequestBodyFilter;
import com.gkht.ai.nexai.framework.web.core.filter.DemoFilter;
import com.gkht.ai.nexai.framework.web.core.handler.GlobalExceptionHandler;
import com.gkht.ai.nexai.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class NexaiWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "nexai.demo", havingValue = "true")
