package com.gkht.ai.nexai.framework.jackson.config;

import com.gkht.ai.nexai.framework.common.util.json.JsonUtils;
import com.gkht.ai.nexai.framework.common.util.json.databind.NumberSerializer;
import com.gkht.ai.nexai.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.gkht.ai.nexai.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class NexaiJacksonAutoConfiguration {
