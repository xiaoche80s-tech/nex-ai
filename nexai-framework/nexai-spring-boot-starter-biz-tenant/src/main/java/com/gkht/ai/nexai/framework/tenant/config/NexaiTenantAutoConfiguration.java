package com.gkht.ai.nexai.framework.tenant.config;

import com.gkht.ai.nexai.framework.common.biz.system.tenant.TenantCommonApi;
...
import com.gkht.ai.nexai.framework.redis.config.NexaiCacheProperties;
import com.gkht.ai.nexai.framework.security.core.service.SecurityFrameworkService;
import com.gkht.ai.nexai.framework.tenant.core.aop.TenantIgnore;
import com.gkht.ai.nexai.framework.tenant.core.aop.TenantIgnoreAspect;
import com.gkht.ai.nexai.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.gkht.ai.nexai.framework.tenant.core.job.TenantJobAspect;
import com.gkht.ai.nexai.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.gkht.ai.nexai.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.gkht.ai.nexai.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.gkht.ai.nexai.framework.tenant.core.redis.TenantRedisCacheManager;
import com.gkht.ai.nexai.framework.tenant.core.security.TenantSecurityWebFilter;
import com.gkht.ai.nexai.framework.tenant.core.service.TenantFrameworkService;
import com.gkht.ai.nexai.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.gkht.ai.nexai.framework.tenant.core.web.TenantContextWebFilter;
import com.gkht.ai.nexai.framework.tenant.core.web.TenantVisitContextInterceptor;
...
import static com.gkht.ai.nexai.framework.common.util.collection.CollectionUtils.convertList;

@AutoConfiguration
@ConditionalOnProperty(prefix = "nexai.tenant", value = "enable", matchIfMissing = true) // 允许使用 nexai.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class NexaiTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "com.gkht.ai.nexai.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     NexaiCacheProperties nexaiCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(nexaiCacheProperties.getRedisScanBatchSize()));
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "com.gkht.ai.nexai.framework.quartz.core.handler.JobHandler")
