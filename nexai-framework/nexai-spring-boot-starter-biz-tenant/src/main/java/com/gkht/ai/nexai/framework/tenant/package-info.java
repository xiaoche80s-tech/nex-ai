 ...
 *      1）Spring Async：
 *          {@link com.gkht.ai.nexai.framework.quartz.config.NexaiAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 NexaiSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.gkht.ai.nexai.framework.tenant;
