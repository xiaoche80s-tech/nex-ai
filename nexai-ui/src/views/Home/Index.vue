        ...
        <template #header>
          <div class="h-3 flex justify-between">
            ...
            <el-link
              type="primary"
              :underline="false"
              href="https://github.com/nexaicode"
              target="_blank"
            >
              {{ t('action.more') }}
            </el-link>
...
const getProject = async () => {
  const data = [
    ...
    {
      name: 'nexai-ui-admin-vue3',
      icon: 'ep:element-plus',
      message: 'github.com/nexaicode/nexai-ui-admin-vue3',
      personal: 'Vue3 + element-plus 管理后台',
      time: new Date('2025-02-03'),
      color: '#409EFF'
    },
    {
      name: 'nexai-ui-mall-uniapp',
      icon: 'icon-park-outline:mall-bag',
      message: 'github.com/nexaicode/nexai-ui-mall-uniapp',
    ...
    },
    {
      ...
      message: 'github.com/YunaiV/nexai-cloud',
      personal: 'Spring Cloud 微服务架构',
      time: new Date('2025-04-05'),
      color: '#1890ff'
    },
    {
      name: 'nexai-ui-admin-vben',
      icon: 'devicon:antdesign',
      message: 'github.com/nexaicode/nexai-ui-admin-vben',
      personal: 'Vue3 + vben5(antd) 管理后台',
      time: new Date('2025-05-06'),
      color: '#e18525'
    },
    {
      name: 'nexai-ui-admin-uniapp',
      icon: 'ant-design:mobile',
      message: 'github.com/nexaicode/nexai-ui-admin-uniapp',
