package com.gkht.ai.nexai.module.infra.service.logger;
...
import com.gkht.ai.nexai.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.gkht.ai.nexai.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.gkht.ai.nexai.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.gkht.ai.nexai.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.gkht.ai.nexai.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.gkht.ai.nexai.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.gkht.ai.nexai.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("nexai-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("nexai-test");
