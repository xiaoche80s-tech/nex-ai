package com.gkht.ai.nexai.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 com.gkht.ai.nexai.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
