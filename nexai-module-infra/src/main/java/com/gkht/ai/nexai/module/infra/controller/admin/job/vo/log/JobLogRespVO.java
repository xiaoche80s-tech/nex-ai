package com.gkht.ai.nexai.module.infra.controller.admin.job.vo.log;
...
import com.gkht.ai.nexai.module.infra.enums.DictTypeConstants;
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "nexai")
