...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.gkht.ai";
    private static final String ARTIFACT_ID = "nexai";
    private static final String PACKAGE_NAME = "com.gkht.ai.nexai";
    private static final String TITLE = "nex-ai智能体平台";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.gkht.ai";
        String artifactIdNew = "nexai";
        String packageNameNew = "com.gkht.ai.nexai";
        String titleNew = "nex-ai智能体平台";
