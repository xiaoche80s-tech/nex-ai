package com.gkht.ai.nexai.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.gkht.ai.nexai.framework.common.enums.CommonStatusEnum;
import com.gkht.ai.nexai.framework.common.enums.UserTypeEnum;
import com.gkht.ai.nexai.framework.common.exception.ServiceException;
import com.gkht.ai.nexai.framework.common.pojo.PageResult;
import com.gkht.ai.nexai.framework.common.util.collection.ArrayUtils;
import com.gkht.ai.nexai.framework.common.util.collection.CollectionUtils;
import com.gkht.ai.nexai.framework.test.core.ut.BaseDbUnitTest;
import com.gkht.ai.nexai.module.infra.api.config.ConfigApi;
import com.gkht.ai.nexai.module.infra.api.file.FileApi;
import com.gkht.ai.nexai.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.gkht.ai.nexai.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.gkht.ai.nexai.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.gkht.ai.nexai.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.gkht.ai.nexai.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.gkht.ai.nexai.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.gkht.ai.nexai.module.system.dal.dataobject.dept.DeptDO;
import com.gkht.ai.nexai.module.system.dal.dataobject.dept.PostDO;
import com.gkht.ai.nexai.module.system.dal.dataobject.dept.UserPostDO;
import com.gkht.ai.nexai.module.system.dal.dataobject.tenant.TenantDO;
import com.gkht.ai.nexai.module.system.dal.dataobject.user.AdminUserDO;
import com.gkht.ai.nexai.module.system.dal.mysql.dept.UserPostMapper;
import com.gkht.ai.nexai.module.system.dal.mysql.user.AdminUserMapper;
import com.gkht.ai.nexai.module.system.enums.common.SexEnum;
import com.gkht.ai.nexai.module.system.mq.producer.user.AdminUserProducer;
import com.gkht.ai.nexai.module.system.service.dept.DeptService;
import com.gkht.ai.nexai.module.system.service.dept.PostService;
import com.gkht.ai.nexai.module.system.service.oauth2.OAuth2TokenService;
import com.gkht.ai.nexai.module.system.service.permission.PermissionService;
import com.gkht.ai.nexai.module.system.service.tenant.TenantService;
...
import static com.gkht.ai.nexai.framework.common.util.collection.SetUtils.asSet;
import static com.gkht.ai.nexai.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.gkht.ai.nexai.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.gkht.ai.nexai.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.gkht.ai.nexai.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.gkht.ai.nexai.framework.test.core.util.AssertUtils.assertServiceException;
import static com.gkht.ai.nexai.framework.test.core.util.RandomUtils.*;
import static com.gkht.ai.nexai.module.system.enums.ErrorCodeConstants.*;
import static com.gkht.ai.nexai.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("nexaiyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("nexaiyuanma");
        ...
        assertEquals("nexaiyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("nexaiyuanma"))).thenReturn("java");
