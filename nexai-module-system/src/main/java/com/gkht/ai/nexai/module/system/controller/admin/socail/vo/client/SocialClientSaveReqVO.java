package com.gkht.ai.nexai.module.system.controller.admin.socail.vo.client;
...
import com.gkht.ai.nexai.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "nexai商城")
