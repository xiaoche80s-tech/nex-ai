package com.gkht.ai.nexai.module.system.service.social;
...
import com.gkht.ai.nexai.framework.common.util.cache.CacheUtils;
import com.gkht.ai.nexai.framework.common.util.http.HttpUtils;
import com.gkht.ai.nexai.framework.common.util.object.BeanUtils;
import com.gkht.ai.nexai.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.gkht.ai.nexai.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.gkht.ai.nexai.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.gkht.ai.nexai.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.gkht.ai.nexai.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.gkht.ai.nexai.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.gkht.ai.nexai.module.system.dal.dataobject.social.SocialClientDO;
import com.gkht.ai.nexai.module.system.dal.mysql.social.SocialClientMapper;
import com.gkht.ai.nexai.module.system.dal.redis.RedisKeyConstants;
import com.gkht.ai.nexai.module.system.enums.social.SocialTypeEnum;
import com.gkht.ai.nexai.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.gkht.ai.nexai.framework.common.util.collection.MapUtils.findAndThen;
import static com.gkht.ai.nexai.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.gkht.ai.nexai.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.gkht.ai.nexai.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${nexai.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${nexai.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/nexai-cloud/pulls/230
